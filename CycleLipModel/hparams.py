...
class hparams:
    ...
    nepochs=50  ### ctrl + c, stop whenever eval loss is consistently greater than train loss for ~10 epochs #Originally 200000000000000000
    num_workers=16
    checkpoint_interval=10 #originally 3000 preset to checkpoint 10
    eval_interval=3000
    ...
    syncnet_checkpoint_interval=10 #Originally 10000
    ...
    # Decoder
    # prenet_layers=[256, 256]  # number of layers and number of units of prenet Altered for the sake of existing architecture Jared
    prenet_dim = 256
    ...
    tacotron_clip_gradients_clip_thresh = 1.0
    ...
    ##Cycle consistency params
    # These values are set inside of the training under cycle_weight
    # lambda_identitiy = 0.5
